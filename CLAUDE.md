...
`.github/instructions/` is a git submodule (`ledger-app-ai-instructions`) carrying generic Ledger embedded-app rules (`RUST.instructions.md`, `EMBEDDED.instructions.md`, `TEST.instructions.md`, `REVIEW.instructions.md`, `C.instructions.md`). Consult these for cross-repo conventions; this `CLAUDE.md` only documents what is specific to this app. The top-level `AGENTS.md` is a symlink into this submodule (`.github/instructions/AGENTS.md`).
