...
BOL_CONF = create_currency_config("CRAB", "Rust Boilerplate", sub_coin_config=None)
...
BOL_CURRENCY_CONFIGURATION = CurrencyConfiguration(ticker="CRAB", conf=BOL_CONF, packed_derivation_path=BOL_PACKED_DERIVATION_PATH)
